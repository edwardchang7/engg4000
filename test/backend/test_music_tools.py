import unittest
from src.backend.music_tools import whole_step,half_step,M3,m3,P5,change_octave,pad_octave_notation,check_interval
...
class TextMusicTools(unittest.TestCase):
  ...
  def test_check_interval_0(self):
    self.assertEqual(check_interval({"note": "D", "degree": "0", "octave": 0}, {"note": "D", "degree": "0", "octave": 0}), ["0"])
